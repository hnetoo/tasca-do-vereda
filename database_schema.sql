-- =============================================
-- BANCO DE DADOS COMPLETO PARA RESTAURANTE
-- Sistema de Gestão de Restaurante - Tasca do Vereda
-- Gerado automaticamente pela análise do código
-- =============================================
...
-- Este script cria uma estrutura completa para um sistema de gestão de restaurante
-- Todas as tabelas referenciadas no código TypeScript estão incluídas
-- Os nomes das tabelas são consistentes com as queries do código
-- Estrutura otimizada para performance com índices apropriados
-- Inclui segurança básica com RLS
-- Dados iniciais para facilitar o início do uso
