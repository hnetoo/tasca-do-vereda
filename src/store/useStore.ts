...
export const useStore = create<StoreState>()(
 ...
 // Initialize menuAccessLogs
    ...
    taxRate: 14,
        ...
        supabaseConfig: {
            enabled: true,
            url: process.env.NEXT_PUBLIC_SUPABASE_URL || "https://ratzyxwpzrqbtpheygch.supabase.co",
            key: process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY || "sb_publishable_brYx8iH2oCK5uVUowtUhTQ_c7X4nrAo",
            autoSync: true
        }
      },
