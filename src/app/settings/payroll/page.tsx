              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => setFormData({...formData, status_pagamento: e.target.value as 'pendente' | 'pago' | 'cancelado'})}
                    className="w-full px-3 py-2 bg-slate-700 border border-slate-600 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-blue-500"
              ...
              {(formData.valor_base || formData.subsidios || formData.descontos) && (
                <div className="mt-4 p-4 bg-slate-700 rounded-lg border border-slate-600">
                  ...
                  <div className="space-y-2 text-sm text-gray-400">
                    <p>Salário Base: {formatCurrency(parseFloat(formData.valor_base) || 0)}</p>
                    <p>Subsídios: {formatCurrency(parseFloat(formData.subsidios) || 0)}</p>
                    <p>Descontos: {formatCurrency(parseFloat(formData.descontos) || 0)}</p>
                    <div className="pt-2 border-t border-slate-600">
                      <p className="font-medium text-white">
                        Total Líquido: {formatCurrency((parseFloat(formData.valor_base) || 0) + (parseFloat(formData.subsidios) || 0) - (parseFloat(formData.descontos) || 0))}
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="flex justify-end gap-3 pt-4">
                ...
                >
                  {loading ? (
                    ...
                    <span>{editingRecord ? 'Atualizar' : 'Adicionar'}</span>
                  )}
                </button>
              </div>
            </form>
